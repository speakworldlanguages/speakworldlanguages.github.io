...
parent.savedProgress[studiedLang].lesson_BIRD_IsViewed=true; // Create and add... or overwrite the same thing
...
const filePathForTheWordOrPhrase = "/speech_recognition_answer_key/"+parent.langCodeForTeachingFilePaths+"/2-1-1-bird.txt";
...
const say1say2Path = "/audio_files_for_listening/"+parent.langCodeForTeachingFilePaths+"/level_2/unit_1/lesson_1/bird_1-2."+soundFileFormat;
const say3Path     = "/audio_files_for_listening/"+parent.langCodeForTeachingFilePaths+"/level_2/unit_1/lesson_1/bird_3."+soundFileFormat;
const say4say5Path = "/audio_files_for_listening/"+parent.langCodeForTeachingFilePaths+"/level_2/unit_1/lesson_1/bird_4-5."+soundFileFormat;
const say6Path     = "/audio_files_for_listening/"+parent.langCodeForTeachingFilePaths+"/level_2/unit_1/lesson_1/bird_6."+soundFileFormat;
const say7say8Path = "/audio_files_for_listening/"+parent.langCodeForTeachingFilePaths+"/level_2/unit_1/lesson_1/bird_7-8."+soundFileFormat;
...
const whatBirdSoundsLike1 = new parent.Howl({  src: ["/lessons_in_iframes/level_2/unit_1/lesson_1/what_bird_sounds_like_1."+soundFileFormat]  });
const whatBirdSoundsLike2 = new parent.Howl({  src: ["/lessons_in_iframes/level_2/unit_1/lesson_1/what_bird_sounds_like_2."+soundFileFormat]  });
const whatBirdSoundsLike3 = new parent.Howl({  src: ["/lessons_in_iframes/level_2/unit_1/lesson_1/what_bird_sounds_like_3."+soundFileFormat]  });
//4
//5
...
function loadingIsCompleteFunction() {
  ...
  if (studiedLang == "ar") {
    const filePathOfTheAudio = "/audio_files_for_listening/"+parent.langCodeForTeachingFilePaths+"/level_2/unit_1/lesson_1/3sfoor_listenbox."+soundFileFormat;
...
function stopListeningAndProceedToNext() {
  ...
  if (!userHasGivenUp) { // User was successful with speech recognition
    parent.savedProgress[studiedLang].lesson_BIRD_IsCompleted=true; // WATCH THE NAME OF THE LESSON!!!
