...
const say1say2Path = "audio_files_from_teachers/"+parent.theLanguageUserIsLearningNow+"/level_1/unit_7/lesson_2/key_1-2.ogg";
const say3say4Path = "audio_files_from_teachers/"+parent.theLanguageUserIsLearningNow+"/level_1/unit_7/lesson_2/key_3-4.ogg";
const say5say6Path = "audio_files_from_teachers/"+parent.theLanguageUserIsLearningNow+"/level_1/unit_7/lesson_2/key_5-6.ogg";
const say7say8Path = "audio_files_from_teachers/"+parent.theLanguageUserIsLearningNow+"/level_1/unit_7/lesson_2/key_7-8.ogg";
...
const keySoundAB = new parent.Howl({  src: ["lessons_in_iframes/level_1/unit_7/lesson_2/keys1.ogg"]  });
const keySoundCD = new parent.Howl({  src: ["lessons_in_iframes/level_1/unit_7/lesson_2/keys2.ogg"]  });
const keySoundEF = new parent.Howl({  src: ["lessons_in_iframes/level_1/unit_7/lesson_2/keys3.ogg"]  });
const keySoundGH = new parent.Howl({  src: ["lessons_in_iframes/level_1/unit_7/lesson_2/keys4.ogg"]  });

const successTone = new parent.Howl({  src: ['user_interface/sounds/success2.ogg']  });
...
function loadingIsCompleteFunction()
{
  ...
  setTimeout(function(){ sayAB.play(); }, 1000+4000);
...
function goFromCDtoEF()
{
  ...
  setTimeout(function(){ sayEF.play(); }, 2000+3500);
  imgC.classList.add("toZeroOpacity");
  imgD.classList.add("toZeroOpacity");
...
function goFromEFtoGH()
{
  ...
  setTimeout(function(){ sayGH.play(); }, 2000+3000);
  imgE.classList.add("toZeroOpacity");
  imgF.classList.add("toZeroOpacity");
