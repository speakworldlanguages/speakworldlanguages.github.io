...
const filePathForTheWordOrPhrase = "/speech_recognition_answer_key/"+parent.langCodeForTeachingFilePaths+"/1-1-3-bread.txt";
...
const say1say2Path = "/audio_files_for_listening/"+parent.langCodeForTeachingFilePaths+"/level_1/unit_1/lesson_3/bread_1-2."+soundFileFormat;
const say3Path     = "/audio_files_for_listening/"+parent.langCodeForTeachingFilePaths+"/level_1/unit_1/lesson_3/bread_3."+soundFileFormat;
const say4say5Path = "/audio_files_for_listening/"+parent.langCodeForTeachingFilePaths+"/level_1/unit_1/lesson_3/bread_4-5."+soundFileFormat;
const say6Path     = "/audio_files_for_listening/"+parent.langCodeForTeachingFilePaths+"/level_1/unit_1/lesson_3/bread_6."+soundFileFormat;
const say7say8Path = "/audio_files_for_listening/"+parent.langCodeForTeachingFilePaths+"/level_1/unit_1/lesson_3/bread_7-8."+soundFileFormat;
...
//const whatBreadSoundsLike1 = new parent.Howl({  src: ["/lessons_in_iframes/level_1/unit_1/lesson_3/what_bread_sounds_like_1."+soundFileFormat]  });
//const whatBreadSoundsLike2 = new parent.Howl({  src: ["/lessons_in_iframes/level_1/unit_1/lesson_3/what_bread_sounds_like_2."+soundFileFormat]  });
//3
//4
//5
...
function loadingIsCompleteFunction() {
  ...
  if (studiedLang == "ja") { // Display note about foreign words in HITO.
    ...
    fetch(pathOfNotificationAboutWesternWords,myHeaders).then(function(response){return response.text();}).then(function(contentOfTheTxtFile){
