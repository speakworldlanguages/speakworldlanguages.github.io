...
const filePathForTheWordOrPhrase = "/speech_recognition_answer_key/"+parent.langCodeForTeachingFilePaths+"/1-3-1-fish.txt";
...
const say1say2Path = "/audio_files_for_listening/"+parent.langCodeForTeachingFilePaths+"/level_1/unit_3/lesson_1/fish_1-2."+soundFileFormat;
const say3Path     = "/audio_files_for_listening/"+parent.langCodeForTeachingFilePaths+"/level_1/unit_3/lesson_1/fish_3."+soundFileFormat;
const say4say5Path = "/audio_files_for_listening/"+parent.langCodeForTeachingFilePaths+"/level_1/unit_3/lesson_1/fish_4-5."+soundFileFormat;
const say6Path     = "/audio_files_for_listening/"+parent.langCodeForTeachingFilePaths+"/level_1/unit_3/lesson_1/fish_6."+soundFileFormat;
const say7say8Path = "/audio_files_for_listening/"+parent.langCodeForTeachingFilePaths+"/level_1/unit_3/lesson_1/fish_7-8."+soundFileFormat;
...
const whatFishSoundsLike1 = new parent.Howl({  src: ["/lessons_in_iframes/level_1/unit_3/lesson_1/what_fish_sounds_like_1."+soundFileFormat]  });
const whatFishSoundsLike2 = new parent.Howl({  src: ["/lessons_in_iframes/level_1/unit_3/lesson_1/what_fish_sounds_like_2."+soundFileFormat]  });
//3
//4
//5
...
var listOfAllSoundsInThisLesson = [
  ...
  whatFishSoundsLike2, whatFishSoundsLike1,
...
function blurABandBringVid1OverAB() {
  ...
  function playVid1NowThatItCanPlayThrough(){
    ...
    whatFishSoundsLike1.play();
    new SuperTimeout(function(){ whatFishSoundsLike1.fade(1,0.33,1000); }, sayTime - 1000);
    new SuperTimeout(function(){      sayC.play();      sayC.once("end", function(){ whatFishSoundsLike1.fade(0.33,1,1000);  });      }, sayTime);
...
function blurCDandBringVid2OverCD() {
  ...
  function playVid2NowThatItCanPlayThrough(){
    ...
    whatFishSoundsLike2.play();
    new SuperTimeout(function(){ whatFishSoundsLike2.fade(1,0.33,1000); }, sayTime - 1000);
    new SuperTimeout(function(){      sayF.play();      sayF.once("end", function(){ whatFishSoundsLike2.fade(0.33,1,1000);  });      }, sayTime);
...
function stopListeningAndProceedToNext() {
  ...
  if (!userHasGivenUp) { // User was successful with speech recognition
    parent.savedProgress[studiedLang].lesson_FISH_IsCompleted=true; // WATCH THE NAME OF THE LESSON!!!
