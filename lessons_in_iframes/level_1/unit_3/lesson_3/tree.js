...
const whatTreeSoundsLike1 = new parent.Howl({  src: ["/lessons_in_iframes/level_1/unit_3/lesson_3/what_tree_sounds_like_1."+soundFileFormat]  }); // Maybe forest ambience or wind or woodpecker sound will suit
const whatTreeSoundsLike2 = new parent.Howl({  src: ["/lessons_in_iframes/level_1/unit_3/lesson_3/what_tree_sounds_like_2."+soundFileFormat]  }); // Maybe forest ambience or wind or woodpecker sound will suit
//3
//4
//5
...
var listOfAllSoundsInThisLesson = [
  ...
  whatTreeSoundsLike2, whatTreeSoundsLike1,
...
function blurABandBringVid1OverAB() {
  ...
  function playVid1NowThatItCanPlayThrough(){
    ...
    whatTreeSoundsLike1.play(); // As of April 2024 audio file contains a few seconds of pure silence
    new SuperTimeout(function(){ whatTreeSoundsLike1.fade(1,0.33,1000); }, sayTime - 1000); // As of April 2024 audio file contains a few seconds of pure silence
    new SuperTimeout(function(){      sayC.play();      sayC.once("end", function(){ whatTreeSoundsLike1.fade(0.33,1,1000);  });      }, sayTime);
...
function blurCDandBringVid2OverCD() {
  ...
  vidsContainer.style.animationDuration = (blurTime/3).toFixed(2)+"s";
  vidsContainer.style.display = "block";
  new SuperTimeout(checkIfVid2CanPlayNiceAndSmooth, blurTime*500 - 900); // Video will start playing 0.9s before it is unblurred
  ...
  function playVid2NowThatItCanPlayThrough(){
    ...
    whatTreeSoundsLike2.play(); // As of April 2024 audio file contains a few seconds of pure silence
    new SuperTimeout(function(){ whatTreeSoundsLike2.fade(1,0.33,1000); }, sayTime - 1000); // As of April 2024 audio file contains a few seconds of pure silence
    new SuperTimeout(function(){      sayC.play();      sayC.once("end", function(){ whatTreeSoundsLike2.fade(0.33,1,1000);  });      }, sayTime);
