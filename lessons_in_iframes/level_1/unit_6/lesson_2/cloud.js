...
const say1say2Path = "audio_files_from_teachers/"+parent.theLanguageUserIsLearningNow+"/level_1/unit_6/lesson_2/cloud_1-2.ogg";
const say3say4Path = "audio_files_from_teachers/"+parent.theLanguageUserIsLearningNow+"/level_1/unit_6/lesson_2/cloud_3-4.ogg";
const say5say6Path = "audio_files_from_teachers/"+parent.theLanguageUserIsLearningNow+"/level_1/unit_6/lesson_2/cloud_5-6.ogg";
const say7say8Path = "audio_files_from_teachers/"+parent.theLanguageUserIsLearningNow+"/level_1/unit_6/lesson_2/cloud_7-8.ogg";
...
const theSoundOfAir = new parent.Howl({  src: ["lessons_in_iframes/level_1/unit_6/lesson_2/nice_wind_seamless_loop.ogg"] , loop:true });
const cloudlySound = new parent.Howl({  src: ["lessons_in_iframes/level_1/unit_6/lesson_2/cloud.ogg"]  });
