...
const say1NaturalPath = "audio_files_from_teachers/"+parent.theLanguageUserIsLearningNow+"/level_1/unit_6/lesson_3/that_cloud_is_like_a_bird_normal.mp3";
const say1Natural = new parent.Howl({  src: [say1NaturalPath]  });
const say1SlowPath = "audio_files_from_teachers/"+parent.theLanguageUserIsLearningNow+"/level_1/unit_6/lesson_3/that_cloud_is_like_a_bird_slow.mp3";
const say1Slow = new parent.Howl({  src: [say1SlowPath]  });
const say2NaturalPath = "audio_files_from_teachers/"+parent.theLanguageUserIsLearningNow+"/level_1/unit_6/lesson_3/that_cloud_is_like_a_fish_normal.mp3";
const say2Natural = new parent.Howl({  src: [say2NaturalPath]  });
const say2SlowPath = "audio_files_from_teachers/"+parent.theLanguageUserIsLearningNow+"/level_1/unit_6/lesson_3/that_cloud_is_like_a_fish_slow.mp3";
const say2Slow = new parent.Howl({  src: [say2SlowPath]  });
const say3NaturalPath = "audio_files_from_teachers/"+parent.theLanguageUserIsLearningNow+"/level_1/unit_6/lesson_3/where_is_the_sun_normal.mp3";
const say3Natural = new parent.Howl({  src: [say3NaturalPath]  });
const say3SlowPath = "audio_files_from_teachers/"+parent.theLanguageUserIsLearningNow+"/level_1/unit_6/lesson_3/where_is_the_sun_slow.mp3";
const say3Slow = new parent.Howl({  src: [say3SlowPath]  });
const say4Path = "audio_files_from_teachers/"+parent.theLanguageUserIsLearningNow+"/level_1/unit_6/lesson_3/the_sun_is_there.mp3";
